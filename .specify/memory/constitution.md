...
- Rationale: Initial creation of the project constitution from user-provided documentation.
- Added sections: All
- Removed sections: None
- Templates requiring updates:
  - C:\Users\Kerpat\Desktop\SteelBike\.specify\memory\constitution.md (✅ updated)
  - C:\Users\Kerpat\Desktop\SteelBike\.specify\templates\plan-template.md (✅ updated)
  - C:\Users\Kerpat\Desktop\SteelBike\.specify\templates\spec-template.md (no update needed)
  - C:\Users\Kerpat\Desktop\SteelBike\.specify\templates\tasks-template.md (no update needed)
- Follow-up TODOs: None
-->

# Конституция проекта PRIZMATIC

## Введение

Этот документ является "конституцией" проекта PRIZMATIC - полным описанием архитектуры, принципов, структуры и правил разработки системы аренды электровелосипедов. Документ служит единым источником истины для всех разработчиков и заинтересованных сторон.

## 1. Обзор проекта

### 1.1 Назначение
PRIZMATIC - это веб-приложение и Telegram-бот для аренды электровелосипедов в городах России (Москва, Санкт-Петербург).
...
├── prizmatic-server/         # Contract Service (Render)
│   ├── server.js             # Express сервер
│   └── package.json          # Зависимости
...
### 12.1 Команда
- **Разработка**: [Ваше имя]
- **Поддержка**: support@prizmatic.ru
