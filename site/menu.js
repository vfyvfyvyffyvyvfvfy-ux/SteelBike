// Общий скрипт для главного меню SteelBike и динамической подгрузки тарифов.
//
...
// или SteelBike) и автоматически открывает меню на главной
// странице, если выбран SteelBike. В меню предусмотрены кнопки для
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Автооткрытие на главной. Ранее для SteelBike меню открывалось автоматически,
    ...
    if (provider && provider !== 'SteelBike' && isIndex) {
